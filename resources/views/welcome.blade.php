        ...
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="text-white-50">
                    <h1 class="text-white font-weight-semibold mb-3 hero-title">Why medicine?</h1>
                    <h4 class="text-white">
    ...
    <div class="container">
        ...
        <div class="row align-items-center pt-4">
            <div class="col-md-6 col-sm-8">
                <div>
                    <img src="{{URL::to('admin/assets/images/homepage2.png')}}" alt="" class="img-fluid mx-auto d-block">
                </div>
            </div>
            <div class="col-md-5 ml-auto">
                <div class="mt-4 mt-md-auto">
                    <div class="d-flex align-items-center mb-2">
                        <h1>Our Project saves medicine to save lives</h1>
                    </div>
                    <h4 class="text-muted">

                        We’re national drug donation law experts who enable health facilities and pharmacies to donate their unused medicine. Our system is built to ensure compliance and provide full liability protection.
                    </h4>
    ...
    <div class="container">
        ...
        <div class="row align-items-center pt-4">
             <div class="col-md-5 mr-auto">
                <div class="mt-4 mt-md-auto">
                    <div class="d-flex align-items-center mb-2">
                        <h1>The National Health Service (NHS) is the publicly funded healthcare system in England</h1>
                    </div>
                    <h4 class="text-muted">
                    The NHS has remained one of the best and most efficient healthcare systems in the world. ... Through a vast network of organisations, the NHS gives value for money, allows fair and equitable access to care, and is adaptable to a changing world.</h4>
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-8">
                <div>
                    <img src="{{URL::to('admin/assets/images/nhs-logo.png')}}" alt="" class="img-fluid mx-auto d-block">
                </div>
            </div>
                        ...
                        <div class="col-lg-2 col-sm-4">
                            <div class="nav flex-column nav-pills" role="tablist">
                                ...
                                <a class="nav-link" id="v-pills-token-sale-tab" data-toggle="pill" href="#v-pills-token-sale" role="tab"> 
                                    ...
                                    <p class="font-weight-bold mb-0">Donation</p>
                                </a>
                                                ...
                                                <div id="gen-ques-accordion" class="accordion custom-accordion">
                                                    <div class="mb-3">
                                                        ...
                                                        <div id="general-collapseOne" class="collapse show" data-parent="#gen-ques-accordion">
                                                            <div class="card-body">
                                                                <p class="mb-0">The National Health Service is the umbrella term for the publicly funded healthcare systems of the United Kingdom. Since 1948, they have been funded out of general taxation. There are three systems which are referred to using the "NHS" name.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div id="general-collapseTwo" class="collapse" data-parent="#gen-ques-accordion">
                                                            <div class="card-body">
                                                                <p class="mb-0">The NHS was born out of a long-held ideal that good healthcare should be available to all, regardless of wealth.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <a href="#general-collapseThree" class="accordion-list collapsed" data-toggle="collapse"
                                                            ...
                                                            <div>Whom we are donating?</div>
                                                            <i class="mdi mdi-minus accor-plus-icon"></i>
                                                        </a>
                                                        <div id="general-collapseThree" class="collapse" data-parent="#gen-ques-accordion">
                                                            <div class="card-body">
                                                                <p class="mb-0">We are donating medicines to help the poor/needy people. They die because the lack of medicines. So we donate medicines for free.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <a href="#general-collapseFour" class="accordion-list collapsed" data-toggle="collapse"
                                                            ...
                                                            <div>Why we are donating?</div>
                                                            <i class="mdi mdi-minus accor-plus-icon"></i>
                                                        </a>
                                                        <div id="general-collapseFour" class="collapse" data-parent="#gen-ques-accordion">
                                                            <div class="card-body">
                                                                <p class="mb-0">The act of helping others, donating to charity, or volunteering your time, will give you an improved sense of wellbeing. The knowledge that you've sacrificed time and/or money in order to help others in need or create positive change in the world is a beautiful thing.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="roadmap-accordion" class="accordion custom-accordion">
                                                    ...
                                                    <div class="mb-3">
                                                        <a href="#roadmap-collapseOne" class="accordion-list" data-toggle="collapse"
                                                            ...
                                                            <div>How we get the donation?</div>
                                                            <i class="mdi mdi-minus accor-plus-icon"></i>
                                                        ...
                                                        <div id="roadmap-collapseOne" class="collapse show" data-parent="#roadmap-accordion">
                                                            <div class="card-body">
                                                                <p class="mb-0">We can get the donations through advertisement of free medicines & we can get the donations through sponsers</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <a href="#roadmap-collapseTwo" class="accordion-list collapsed" data-toggle="collapse"
                                                            ...
                                                            <div>Who is associated with us?</div>
                                                            <i class="mdi mdi-minus accor-plus-icon"></i>
                                                        </a>
                                                        <div id="roadmap-collapseTwo" class="collapse" data-parent="#roadmap-accordion">
                                                            <div class="card-body">
                                                                <p class="mb-0">Ngo's are associated with us with NHS and Eidhi Foundation.</p>
                                                            </div>
                                                        </div>
                                                    </div>
