...
@section('title', 'Reward Create - PrepareHOW')
@section('content')
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">Reward Create</h4>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ URL::to('admin/reward/submit') }}" enctype="multipart/form-data" method="post">
                    @csrf 
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            <label>Coins</label>
                            <input type="text" name="coins" class="form-control" required>
                        ...
                        <div class="form-group col-md-4">
                            <label>Limit</label>
                            <input type="number" name="limit" class="form-control" min="0" required>
                    ...
                    <div class="form-row mt-4">
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="ad" cols="30" rows="5" class="form-control"></textarea>
                        </div>
                    </div>
