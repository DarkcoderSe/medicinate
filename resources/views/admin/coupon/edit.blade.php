...
@section('title', 'Coupon Edit - PrepareHOW')
@section('content')
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">Coupon Edit</h4>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ URL::to('admin/coupon/update') }}" enctype="multipart/form-data" method="post">
                    @csrf 
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="max_limit" class="form-control" value="{{ $coupon->max_limit }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="usage_limit_per_student" class="form-control" value="{{ $coupon->usage_limit_per_student }}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="discount_amount" class="form-control" value="{{ $coupon->discount_amount }}">
                        ...
                        <div class="col-md-1">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="status" {{ $coupon->status ? 'checked' : '' }}>
                                    Active
                                </label>
                            </div>
                        </div>
