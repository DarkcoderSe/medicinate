    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="mainFromCreate" action="{{ URL::to('admin/permission/update') }} " method="post">
                    @csrf 
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            <label>Name</label>
                            <input type="text" id="name" name="name" class="form-control" value="{{ $permission->name }}" disabled>
